...
Please note the code has been produced by writing a spec document - that you can find here - and asking Microsoft Copilot to generate most of the code. The spec is written in Italian, it can be a great opportunity to learn some Italian!
